CREATE OR REPLACE PACKAGE TBCIS.CALCULATE_FIXED_CHARGES IS
   /*
   **
   **  Module Ref  : BCCU659
   **  Module Name : CALCULATE_FIXED_CHARGES   
   **
   ...
   **  2.78   09.01.2019   Andres Jaek  DOBAS-1622 Uue DCH tüüpi kirjete daily_charge='Y' välistamine päringutes
   **                                              Muudetud protseduurid: get_from_to_special_price, get_credit_fixed_charge_data, get_fcit_by_bise_sety, get_fcit_by_sety_paca
   **                                              Muudetud protseduur: create_invoice_entry   
   **  2.77   01.10.2018   Inge Reeder  DOBAS-1205 Arvelduses proportsionaalse leppetrahvi arvutuse täiendus SPOC koodi alusel
   **                                              Muudetud protseduur: create_invoice_entry   
   **  2.76   06.09.2018   Inge Reeder  DOBAS-1107 Arvelduses proportsionaalse leppetrahvi arvutus
   **                                              Muudetud protseduur: create_invoice_entry
   **  2.75   14.08.2018   Inge Reeder  DOBAS-813: "Simman tasulised teenused"
   **                                              Uus protseduur: INSERT_SERVICE_INEN
   **  2.74   21.03.2018   Inge Reeder  DOBAS-665: Kui teenuse parameetriks on ARVERIDA(NW_PARAM_NAME = FCIT), siis FCIT loetakse teenuse parameetrist
   **                                              Muudetud protseduur:
   **                                               -- once_off_charge (lisasin uue parameetri p_fcit_type_code)
   **  2.73   08.11.2017   Inge Reeder  DOBAS-262: Kliendipõhised onceoff teenuste soodustused
   **                                              Muudetud protseduur:
   **                                               -- create_invoice_entry
   **  2.72   20.10.2017   Inge Reeder  DOBAS-243: Koondarve staatuse muutmine INI->AC, kui hakatakse tegema arverida
   **                                              Muudetud protseduur:
   **                                               -- fixed_charge_calc
   **                                              Uus protseduur: Chg_INI_Maac_to_AC
   **  2.71   21.02.2017   Inge Reeder  MOBET-76: Muudetud protseduur:
   **                                               -- chk_one_maac_ma_MON_discounts
   **  2.70   12.01.2017   Inge Reeder  MOBET-23: Muudetud protseduurid:
   **                                               -- monthly_maas_sety_charge  (cursor c_masa, dico_ref_num)
   **                                               -- invoice_maac_service_month_chg(sisesndparameeter p_dico_ref_num)
   **                                               -- monthly_ma_sety_charge (sisendparameetr p_dico_ref_num)
   **                                               -- calc_maac_serv_monthly_charge (sisendparameeter p_dico_ref_num)
   **                                             Uus protseduur: chk_one_maac_ma_MON_discounts
   **  2.69   15.12.2016 A.Soo,H.Luhasalu AVL-49:  Lepingu peatamise kuutasu
   **                                            Procedures modified:
   **                                              -- invoice_service_mon_charge
   **                                            New function:
   **                                              -- find_avl_num_days
   **  2.68   12.04.2016   A.Soo        MOBE-540: Jagatava interneti lisamahu ostmisel grupi nimi arvel
   **                                            Procedures modified:
   **                                              -- create_invoice_entry
   **                                              -- fixed_charge_calc
   **                                              -- once_off_charge
   **  2.67   08.12.2015   A.Soo        MOBE-425: Jagatava interneti grupi nimi arvel
   **                                            Procedures modified:
   **                                              -- create_entries
   **                                              -- invoice_maac_service_month_chg
   **  2.66   05.06.2015   A.Soo        SFILES-451: Koondarve teenuste kuutasude TC päevade loogika.
   **                                            TC päevade eest raha ei võeta (TC päev = teenus ajutiselt suletud vähemalt pool päeva)
   **                                            Procedures modified:
   **                                              -- invoice_maac_service_month_chg
   **                                              -- main_master_service_charges
   **                                              -- calculate_masp_days
   **  2.65   05.06.2015   A.Soo        ETEENUP-41 / ETEENUP-128: Komplekti kuutasu arvutamise loogika täiendus
   **                                   Muudatused ETEENUP-41 kataloogis.
   **                                            Procedures modified:
   **                                              -- Get_EMTPL_Mixed_Sety_Mon
   **  2.64   08.01.2015   A.Soo        CHG-13618 IS-17713 - MKONT liitumistasu parandus
   **                                            Procedures modified:
   **                                              -- create_invoice_entry
   **  2.63   03.11.2014   A.Soo        CHG-13979 IS-19886 - Sulgeda lahti jäävad kursorid
   **                                            Procedures modified:
   **                                              -- create_invoice_entry
   **  2.62   24.04.2014   A.Soo        CHG-13643 IS-17830 - MultiSIM - Kuutasu arvutamisel vajalik kasutada tunnust FREE_PERIODS
   **                                            Procedures modified:
   **                                              -- main_master_service_charges
   **                                              -- monthly_maas_sety_charge
   **                                              -- monthly_ma_sety_charge
   **                                              -- calc_maac_serv_monthly_charge
   **                                              -- invoice_maac_service_month_chg
   **  2.61   13.03.2014   A.Soo        CHG-13617 IS-17074: MinuEMT kuutasude seos tabelisse COMMON_MONTHLY_CHARGES
   **                                            Procedures modified:
   **                                              -- add_invoice_entry
   **                                              -- write_down_invoice_entries
   **  2.60   03.01.2014   A.Soo        CHG-13407 IS-15917: Koondarveteenuse kuutasu - MultiSIM
   **                                            Procedures modified:
   **                                              -- main_master_service_charges
   **  2.59   13.01.2014   A.Soo        CHG-6472 IS-13220: CG teenuse muutmise from-to hinnad.
   **                                            Procedures modified:
   **                                              -- get_from_to_special_price
   **  2.58   12.12.2012   A.Soo        CHG-6214 IS-11555: Charge last month prorated if package closed.
   **                                            Procedures modified:
   **                                              -- calc_non_prorata_package_repl
   **  2.57   05.09.2012   I.Jentson   IS-11504   Procedures modified:
   **                                              period_fixed_charges
   **  2.56   11.05.2012   E.Naarits   CHG-5795
   **                                              Procedures modified:
   **                                              once_off_charge,
   **                                              fixed_charge_calc,
   **                                             create_invoice_entry
   **                                             lisatud väli ebs_order_number väljakutsetesse.
   **  2.55   07.05.2012   A.Soo        CHG-5762 Packaged Sale Vol.2 - REPL
   **                                            Procedures modified:
   **                                              -- calc_non_prorata_package_repl
   **                                              -- create_update_entry
   **  2.54   11.04.2012   A.Soo        CHG-5438 Packaged Sale Vol.2
   **                                            New procedures:
   **                                              -- Get_EMTPL_Mixed_Sety_Mon
   **                                              -- create_update_entry
   **                                            Procedures modified:
   ...
   **                                              -- once_off_charge
   **                                              -- connection_charge
   **                                              -- get_fcit_by_bise_fcit
   **  2.53   15.09.2011   A.Soo        CHG-5186 Packet compensation BISE and FCIT
   **                                            New function:
   **                                              -- get_fcit_by_bise_fcit
   **                                            Procedures modified:
   **                                              -- fixed_charge_calc
   **                                              -- create_invoice_entry
   **  2.52   30.03.2011   A.Soo        CHG-4899 Käibemaksu ei arvutata koheselt arverea/arvereale lisamisel, vaid arve sulgemisel.
   **                                            Müügiregistrisse Tähtajalise lepingu ennetähtaegsel lõpetamisel leppetrahv kantakse avatud arvele ilma
   **                                            käibemaksuta ja samal ajal salvestatakse tähtajalisse lepingusse (FIXED_TERM_CONTRACTS)
   **                                            leppetrahv ja arvutatud käibemaks 3-kohta peale koma.
   **                                            Procedures modified:
   **                                              -- create_invoice_entry   
   **                                              -- calc_non_prorata_package_repl                                              
   **  2.51   09.02.2011   A.Soo        CHG-4926 Pere250 parandus - muudetud kursorit c_maas (sulud paigast ära).
   **                                            Procedures modified:
   **                                              -- calc_non_prorata_ma_serv_chg
   **  2.50   20.01.2011   A.Soo        CHG-4803 Pere250 - kuutasudesse ei tohi võtta teenuseid, millel on määratud mobiilipakett.
   **                                            Procedures modified:
   **                                              -- calc_non_prorata_ma_serv_chg
   **  2.49   29.10.2010   K.Peil       CHG4594, IS-5573: INEN.EEK_AMT töötlemise asemel INEN.ACC_AMOUNT täpsusega
   **                                   GET_INEN_ACC_PRECISION (cache'itud paketi konstandis G_INEN_ACC_PRECISION)
   **                                   alamprogrammides:
   **                                   - INS_COMMON_MONTHLY_CHARGES, ühtlasi määratud parameetri tüübiks
   **                                     INVOICE_ENTRIES%ROWTYPE ja lisatud EEK_AMT väärtustamine väljundis
   **                                   - CREATE_ENTRIES
   **                                   - RECALC_INVO_DISCOUNT
   **                                   - CALC_NON_PRORATA_PACKAGE_REPL
   **                                   - CREATE_INVOICE_ENTRY, lahtine küsimus INEN.FIXED_CHARGE_VALUE teemal
   **                                   - CREATE_ENTRIES
   **                                   - ADD_INVOICE_ENTRY, lisatud EEK_AMT väärtustamine väljundis
   **                                   - WRITE_DOWN_INVOICE_ENTRIES, lisatud EEK_AMT väärtustamine väljundis
   **  2.48   20.10.2010   A.Soo        CHG-4658 Master Account Fixed Term Buy.
   **                                            Procedures modified:
   **                                              -- get_from_to_special_price
   **  2.47   01.06.2010   A.Soo        CHG-4467 MeieEMT monthly fees fix.
   **                                            Procedures modified:
   **                                              -- calc_non_prorata_ma_serv_chg
   **  2.46   13.05.2010   A.Soo        CHG-4418 MeieEMT. MA service monthly fees.
   **                                            Procedures modified:
   **                                              -- period_fixed_charges
   **  2.45   26.03.2010   A.Soo        CHG-4313 Added MA service support to from-to price.
   **                                            Procedures modified:
   **                                              -- get_from_to_special_price
   **  2.44   12.11.2009   A.Soo        CHG-3360 Cursor fixes, added NVL to special_mark.
   **                                            Procedures modified:
   **                                              -- calc_non_prorata_maac_pkg_chg
   **  2.43   21.05.2009   A.Soo        CHG-3832 Added support for REPL Interim invoices.
   **                                            Procedures modified:
   **                                              -- calc_non_prorata_package_repl
   **  2.42   04.05.2009   A.Soo        CHG-3811 POP. Changed REPL type package charge first prorated daycount calculation.
   **                                            Procedures modified:
   **                                              -- calc_non_prorata_package_repl
   **  2.41   27.04.2009   A.Soo        CHG-3714 POP. Chanegd procedure ins_common_monthly_charges to public procedure.
   **                                            New procedure:
   **                                              -- calc_non_prorata_package_repl
   **                                            Procedures modified:
   **                                              -- calc_non_prorata_maac_pkg_chg
   **                                              -- calc_non_prorata_package_chg
   **  2.40   09.04.2009   A.Soo        CHG-3770 Modified from-to price cursor.
   **                                            Procedure modified:
   **                                              -- get_from_to_special_price
   **  2.39   27.02.2009   K.Peil       CHG-1634 CHG3645 muudatused asendatud selle CHG-ga
   **         14.01.2009   M.Teino               Täiendatud alamprogramme GET_FROM_TO_SPECIAL_PRICE, ONCE_OFF_CHARGE, FIXED_CHARGE_CALC, EXIST_FIXED_CHARGE_FOR_SETY, CREATE_INVOICE_ENTRY
   **         12.02.2009   A.Soo                 Fixterm. Modified procedure:
   **                                              -- create_invoice_entry
   **  2.38   05.02.2009   A.Soo        CHG-3645 Register PAK compensation date.
   **                                            Procedure modified:
   **                                              -- create_invoice_entry
   **  2.37   14.01.2009   A.Soo        CHG-3345 PAK Returning.
   **                                            New procedure:
   **                                              -- Get_Non_Prorata_Package_Charge
   **                                            Procedure modified:
   **                                              -- calc_non_prorata_maac_pkg_chg: exclude PAK and PAT packages
   **                                              -- create_invoice_entry
   **  2.36   10.12.2008   A.Soo        CHG-3516 KERKOP - OnceOff services can be ordered to closed M/A.
   **                                            Procedure modified:
   **                                              -- fixed_charge_calc
   **  2.35   03.12.2008   A.Soo        CHG-2795 Teenuste FIX tasude erinevad häälestused.
   **                                            Muudetud protseduure:
   **                                              -- calc_service_monthly_charge
   **                                              -- invoice_service_mon_charge
   **                                              -- create_invoice_entry
   **                                              -- find_num_of_days
   **                                            Uus protseduur:
   **                                              -- Get_Dependent_Price
   **  2.34   13.08.2008   A.Soo        CHG-3180 Paketeeritud müügi täiendus - leppetrahv viimati suletud FTCO peale.
   **                                            Liitumistasu täiendus.
   **                                            Muudetud protseduure:
   **                                              -- create_invoice_entry
   **                                              -- fixed_charge_calc
   **                                              -- connection_charge
   **  2.33   22.07.2008   A.Soo        CHG-3060 Paketeeritud müük. Muudetud protseduuri: create_invoice_entry
   **  2.32   10.06.2008   A.Soo        CHG-2297 OnceOff dokumendi teenused. Lisandus uus protseduur - Get_OO_Service_Price.
   **  2.31   19.05.2007   A.Soo        CHG-3005 Uus protseduur prorata tariifi leidmiseks: Get_Prorata_Mob_Serv_Price.
   **  2.30   25.06.2007   S.Sokk       CHG-2110 Replaced USER with sec.get_username
   **  2.29   19.02.2007   A.Soo        CHG-1394 Muudetud protseduuri: Exclude_Mobile_Package_Charges
   **  2.28   27.10.2006   I.Priks      CHG-323  Lisatud Get_From_To_Special_Price meetodi deklaratsioon ka paketi päisesse, et saaks ka mujalt välja kutsuda.
   **  2.27   19.06.2006   U.Aarna      CHG-323  Lisatud onceoff maksustamisele paketi või teenuse parameetri lähte- ja lõpp-väärtuse
   **                                            alusel erihinna leidmise loogika.
   **  2.26   16.08.2006   U.Aarna      CHG-1132 Pere kuutasu arvutamisel võetakse lisaks kuu lõpus avatud parameetritele arvesse ka need parameetrid,
   **                                            millised on suletud koos kuu jooksul suletud mobiiliga. Jäetakse välja parameetrid, millised on suletud
   **                                            ja mobiilid on avatud.
   **  2.25   07.06.2006   U.Aarna      CHG-978  Pere kuutasu arvutamisel võetakse antud mobiilinumbri kõik kehtivad susg-id arveldusperioodis
   **                                            (eelnevalt oli arveldusperioodi lõpu seisuga kehtinud susg).
   **  2.24   27.03.2006   M.Teino      CHG-776  Eemaldatud valuutaväljade (..._CURR) ja valuutakoodi (CURR_CODE) täitmine
   **                                            tabelites INVOICE_ENTRIES ja INVOICE_ENTRIES_INTERIM, lisatud PRI_CURR_CODE lisamine antud tabelitesse
   **                                            Protseduurid: create_invoice_entry, create_entries, add_invoice_entry ja write_down_invoice_entries
   **                                            PROCEDURE create_invoice_entry, create_entries, add_invoice_entry, write_down_invoice_entries - rahaväljade ümardamine kahe komakohani
   **  2.23   23.03.2006   U.Aarna      CHG-742  Lisatud teenuse YKT (masterkonto ühtne kuutasu) kõrvale teenuse PERE (pere kuutasu)
   **                                            loogika.
   **  2.22   02.12.2005   U.Aarna      CHG-498  Lisatud mobiili taseme teenuste päevade arvust sõltumatute (prorata=N) kuutasude
   **                                            maksustamiseks vajalikud protseduurid.
   **  2.21   16.11.2005   U.Aarna      CHG-464  Teenuste kuutasude arvestus mälutabelitesse salvestatud hinnakirja alusel.
   **  2.20   20.04.2005   U.Aarna      CHG-69   Lisatud päevade arvust sõltumatute paketi kuutasude arvutus. Uus globaalne protseduur
   **                                            Calc_Non_ProRata_Maac_Pkg_Chg ja lokaalne protseduur Calc_Non_ProRata_Package_Chg.
   **  2.19   10.03.2005   U.Aarna      UPR-3284 Protseduur MONTHLY_SETY_CHARGE muudetud lokaalseks, kuna paketivälist kasutust
   **                                            ei leidnud ning 10g all enam pakett ei kompileerunud seoses sellega, et päises
   **                                            ja kehas omas parameeter p_create_entry erinevat vaikimisi väärtust.
   **  2.18   11.11.2004   U.Aarna      UPR-3194 Lisatud kontroll: ühtne kuutasu arvestatakse Masterile ainult 1-kordselt ka
   **                                            juhul kui vigase sisestuse tõttu on avatud vastavaid Master teenuseid > 1.
   **  2.17   22.09.2004   U.Aarna      UPR-3124 Kuumaksude arvutusse lisatud ühise kuutasu arvestamise loogika.
   **  2.16   04.05.2004   U.Aarna      UPR-3007 Lisatud funktsioon Get_FCIT_By_SETY_PACA.
   **                                            Once Off charge korral ka võimalus juba ette antud summaga arvutama tulla
   **                                            (analoogiliselt Cond Fixed Charge).
   **  2.15   24.03.2004   H.Luhasalu   UPR-2977 Teenuse kuumaksude arvutamisel (parameetrite järele) viga, kui teenus suletud
   **                                            ja kohe avatud avatud samade parameetritega.
   **  2.14   25.11.2003   U.Aarna      UPR-2822 Cond_Fixed_Charge korral, kui amt ette antud ja ei ole vaja otsida price list
   **                                            kursoritest, siis lubatud ka 0 ja negatiivse summa kandmine arvereale.
   **  2.13   23.10.2003   U.Aarna      UPR-2794 Lisatud funktsioon Get_FCIT_By_BISE_SETY.
   **                                            Protseduuri Create_Invoice_Entry lisatud järelmaksu makse kandmine arvele
   **                                            (makstav summa on ette antud).
   **                                            Protseduuri Fixed_Charge_Calc muudetud, lisatud sisendparameetrid järelmaksu
   **                                            maksete jaoks ja väljundparameeter p_invo_ref_num.
   **                                            Uued parameetrid protseduuris Cond_Fixed_Charge.
   **  2.12   06.06.2003   H.Luhasalu   UPR-2643 MA teenuste kuumaksude arvutamisel muudetud loogika(parameetrid).
   **  2.11   22.05.2003   M.Sabul      UPR-2541 Sama UPR-i käigus muudetud protseduuri:MONTHLY_MAAS_SETY_CHARGE
                                                 Jäi lõpmatusse tsüklisse , kuna ei osanud korrektselt välja tulla.Süüdi timefaktori
                                                 väär arvestamine.
   **  2.11   03.04.2003   U.Aarna      UPR-2541 Muudetud Create_Invoice_Entry: kõik kursorite väljakutsed teenuse parameetri
   **                                            ja teenuse tasemel tehtud üksteist välistavaks. Kui on antud sepv_ref_num
   **                                            NOT NULL (või param_charge NOT NULL), siis küsitakse ainult teenuse
   **                                            parameetri tasemel ja teenuse taseme kursorit ei küsita. Kui on sepv_ref_num
   **                                            NULL, siis küsitakse teenuse tasemel.
   **         25.04.2003                         Muudetud Create_Invoice_Entry: lisatud parameeter sepa_ref_num, mida kasutatakse
   **                                            teenuse parameetri taseme kursorites.
   **  2.10   17.02.2003   H.Luhasalu   UPR-2467 Teenuste parameetri päevade arv.Parandatud.
   **  2.9    06.02.2003   H.Luhasalu   UPR-2454 MA teenuste kuumaks erihindadest ka 0 väärtusega.
   **  2.8    16.11.2002   H.Luhasalu   UPR-2351 Mitmekordne ühekordne makse-parameeter juures (count)
   **                                            OO,CONN,COND hinna küsimise kuupäeva trunc.
   **                                            Aktiivsuse otsimine:trunc.
   **  2.7    16.08.2002   H.Luhasalu   UPR-2240 Käibemaksuga once_off ja conn maksud
   **  2.6    06.08.2002   H.Luhasalu   UPR-2226 Dbms_output välja kommenteeritud
   **  2.5    20.05.2002   T.Hipeli     UPR-1991 muudetud Create_invoice_entry, Monthly_sept_charge,
   **                                            Monthly_prli_sept_charges, Monthly_prli_sety_charges,
   **                                            Monthly_sety_charge, Period_fixed_charges
   **  2.4    25.03.2002   U.Aarna      UPR-2111 Bug fixes.
   **  2.3    22.12.2001   H.Luhasalu   UPR-2031 Find.. teenuste staatustes null väärtuse kontr.
   **  2.2    06.12.2001   H.Luhasalu   UPR-1986 Muudetud teenuste staatus perioodide arvutust.
   **                                            Teenused arvestavad mobiili AC ja parameeter hinnatakse päeva alguse järgi.
   **  2.1    03.10.2001   H.Luhasalu   UPR-1939 Hinna kursorid võtavad null väärtust.Create_Invoice_Entry.Check_fixed_charge.
   **  2.0    06.07.2001   M.Sabul      UPR-1843 Cursor C_masa .Viga. 0-soodustust ei saanud
   **                                            M/A teenused.
   **  1.9    28.05.2001   M.Sabul      UPR-1805 Create_Entries; lisatud maas_ref_num
   **                                            Monthly_maas_sety_charge.create_entries väljakutse
   **  1.8    17.04.2001   M.Sabul      UPR-1508 Lisatud funktsioonid Has_M_A_services
   **                                           ,Exist_fixed_charge_for_sety,
   **                                           ,protseduurid:Monthly_maas_sety_charge,
   **                                           ,Main_Master_service_charges
   **                                           ,parandatud:create_entries (susg=null)
   **  1.7    25.04.2001   H.Luhasalu   UPR-1769    Kuumaksu arvutamisel hinnakursor vale. "Tuleviku pindala"
   **  1.6    01.04.2001   H.Luhasalu   UPR-1667    Lisatud protseduur Period_Fixed_Charges.Find_Pack_days
   **                                               arvestab kuu algust TC korral.Muudetud Monthly_sept_charges
   **                                               ja Monthly_Sety_Charges kuumaks "pindalaks" kahe hinnatabeli vahel.
   **  1.5    05.03.2001   H.Luhasalu   UPR-1726    Monthly_sety_charge parandus - Fixed_charge_values
   **  1.4    27.02.2001   H.Luhasalu   UPR-1723    COND-FIXED-CHARGE's parameetrite parandus väljakutsumisel
   **  1.3    17.02.2001   H.Luhasalu   UPR-1649    Lisatud Par_Value_Charge,Channel_type, tabel Price_Lists
   **                                               Lisatud protseduurid: Get_num_of_days,Find_pack_days
   **                                               Create_entries,Monthly_sept_charge,Monthly_sety_charge
   **                                               Find_num_of_days.
   **  1.2    12.12.2000   U.Aarna      UPR-1665    Additional parameter order_date for connection charge calculation.
   **                                               Used in discount calculations. When order date has value, this value
   **                                               is used, otherwise service date is used.
   **  1.1    30.11.2000   M.Kampus     UPR-1658    Näpukas Conditional Fix Charge's
   **  1.0    21.11.2000   U.Aarna      UPR-1637    Connection discount functionality added:
   **                                                 -- Procedure Create_Invoice_Entry modified,
   **                                                 -- New procedure Create_Credit_Invoice_Entry added.
   **  1.0    30.10.2000   I.Stolfot    UPR-1615    Added OUT parameter p_inen_ref_num:
   **                                                   Create_Invoice_Entry
   **                                                   Cond_Fix_Charge
   **                                                   Fixed_Charge_Calc
   **  1.0    12.05.2000   M.Kampus     UPR-1508    1) Once Off
   **         22.10.2000                            2) Connection
   **                                               3) Conditional Fix Charge
   ** ----------------------------------------------------------------------
   ** ONCE_OFF_CHARGE/CONNECTION_CHARGE/COND_FIX_CHARGE
   **                ( p_maac_ref_num   IN Master Account Reference Number,
   **                  p_susg_ref_num   IN Subscriber Reference Number,
   **                  p_chca_type_code IN Charging Category Type code,
   **                  p_package_type   IN Package Type code,
   **                  p_service_date   IN Request Date,
   **                  p_sety_ref_num   IN Service reference Number,
   **                  p_sepv_ref_num   IN Service Parameter Value Reference Number,
   **                  p_run_mode       IN Called from form then ='Fxxx'
   **                                         Commit/rollback on the form level
   **                                      or from sql,then ='BATCH' and all messages
   **                                         in the sql table G_Message_Table
   **                                         should use Commit/rollback and
   **                                         Write_Batch_messages and Commit
   **                  p_error_text     IN OUT
   **                  p_error_type     IN OUT W-warning/E-error
   **                  p_success        IN OUT TRUE/FALSE
   **                  p_trunsact_mode  IN VARCHAR2 Default 'INS' -- Conn.Charge
   **                  );
   ***********************************************************************/
   ...
   /*
     ** Type declarations
   */
   TYPE t_inen IS TABLE OF invoice_entries%ROWTYPE
      INDEX BY BINARY_INTEGER;

   --
   TYPE r_inen_sum IS RECORD (
   ...
   --
   TYPE t_inen_sum IS TABLE OF r_inen_sum
      INDEX BY BINARY_INTEGER;
   ...
   TYPE t_varchar10 IS TABLE OF VARCHAR2 (10)
      INDEX BY BINARY_INTEGER;

   /*
     ** Global Constants
   */
   bcc_module_ref       CONSTANT VARCHAR2 (10) := 'BCCU659';
   bcc_inve_mod_ref     CONSTANT VARCHAR2 (4) := 'U659';
   bcc_proc_name                 VARCHAR2 (30);
   bcc_sql_values       CONSTANT NUMBER := 158;
   bcc_sql_err          CONSTANT NUMBER := 142;
   bcc_warning          CONSTANT NUMBER := 9999;

   TYPE g_message_table IS TABLE OF NUMBER
      INDEX BY BINARY_INTEGER;

   TYPE g_mesgparam_table IS TABLE OF VARCHAR2 (100)
      INDEX BY BINARY_INTEGER;

   /* Message tables */
   g_message_count               BINARY_INTEGER := 0;
   g_mesg_num                    g_message_table;
   g_mesg_param1                 g_mesgparam_table;
   g_mesg_param2                 g_mesgparam_table;
   --
   c_min_ykt_susgs      CONSTANT NUMBER := TO_NUMBER (RTRIM (LTRIM (get_system_parameter (310))));
   c_max_ykt_susgs      CONSTANT NUMBER := TO_NUMBER (RTRIM (LTRIM (get_system_parameter (311))));
   c_min_ac_days_for_pkg_fees CONSTANT NUMBER := TO_NUMBER (RTRIM (LTRIM (get_system_parameter (375))));
   g_inen_acc_precision CONSTANT NUMBER := get_inen_acc_precision;   -- CHG4594
   --
   g_inen_rowid                  VARCHAR2 (30);   -- CHG-71
   ...
   FUNCTION get_fcit_by_bise_sety (
     ...
     ,p_pro_rata        IN  fixed_charge_item_types.pro_rata%TYPE
      ...
      RETURN fixed_charge_item_types%ROWTYPE;
   ...
   PROCEDURE get_from_to_special_price (
     ...
     ,p_tax                  OUT     NUMBER
     ,p_success              IN OUT  BOOLEAN   -- CHG1634
     ,p_error_text           IN OUT  VARCHAR2   -- CHG1634
   );
...
--
END calculate_fixed_charges;
/

CREATE OR REPLACE PACKAGE BODY TBCIS.CALCULATE_FIXED_CHARGES IS
   --
   --Module BCCU659
   --
         ...
         IF l_charge_value <> 0 THEN
            IF p_create_entry = 'B' THEN
               ...
               */
               ...
               --
               Calculate_Fixed_Charges.create_entries (p_success          => p_success                     --IN OUT  BOOLEAN
   ...
   */
            ...
            */
            IF l_fixed_term_type IS NOT NULL OR p_fixed_term_category IS NOT NULL THEN
               ...
               IF 	 l_ftco_rec.spoc_type_code is not null  
                 ...
                 --AND l_ftco_rec.date_closed is null	
                 THEN
      ...
      FOR rec_v IN c_values_sept (p_sept_type_code, p_invo_end_date, 'Y', p_start_date) LOOP
         ...
         IF l_start_value_date IS NULL THEN
            IF rec_v.start_date > p_start_date THEN
               ...
               calculate_fixed_charges.monthly_prli_sept_charge
                                                          (p_success   -- IN OUT BOOLEAN
                                                          ,p_err_text   -- IN OUT VARCHAR2
                                                          ,p_invo   --        INVOICES%ROWTYPE
                                                          ,p_end_day_num   --        NUMBER
         ...
         ELSE
            IF TRUNC (rec_v.start_date) > TRUNC (l_end_value_date + 1) THEN
               ...
               calculate_fixed_charges.monthly_prli_sept_charge (p_success
                                                                ,p_err_text
   ...
   BEGIN
            ...
            ELSE
               IF l_sepv = p_sepv_ref_num THEN
                  IF l_start = l_start1 THEN
                     ...
                     i := 0;
                  ELSE
                     l_num := calculate_fixed_charges.find_pack_days (l_start1
      ...
      IF l_start1 IS NOT NULL AND l_sepv1 = p_sepv_ref_num THEN
         ...
         l_num := calculate_fixed_charges.find_pack_days (l_abi
         ...
         FOR rec IN c_stat_periods (p_susg_ref_num, p_sety_ref_num, p_months_after) LOOP
            ...
            ELSE
               ...
               IF TRUNC (l_start) <> TRUNC (l_start_1) THEN
                  ...
                  l_num := calculate_fixed_charges.find_pack_days (l_start_1
...
;
   ...
   BEGIN
      ...
      FOR rec_pack IN c_all_pack (p_maac_ref_num, p_susg_ref_num, p_period_start, p_period_end) LOOP
         ...
         calculate_fixed_charges.monthly_sept_charge (l_success
                                                     ,p_error_text
      ...
      LOOP
         IF l_serv.sept_type_code IS NULL THEN
            ...
            IF p_main_bill THEN
               ...
               */
               calculate_fixed_charges.calc_service_monthly_charge
            ...
            ELSE
               ...
               */
               calculate_fixed_charges.monthly_sety_charge
                                                  (l_success   -- IN OUT BOOLEAN
                                                  ,p_error_text   -- IN OUT VARCHAR2
                                                  ,p_invo_details   -- IN     INVOICES%ROWTYPE
                                                  ,l_num_days   -- p_end_day_num    IN     NUMBER
      ...
      IF p_inv_entry = 'B' THEN
         IF p_invo_details.invoice_type = 'INB' THEN
            ...
            */
            ...
            calculate_fixed_charges.calc_non_prorata_ma_serv_chg
                                                (p_maac_ref_num   -- IN     master_accounts_v.ref_num %TYPE
         ...
         */
         process_monthly_service_fees.chk_one_maac_ma_calculated_fee
                                                                 (p_maac_ref_num   --IN     master_accounts_v.ref_num%TYPE
