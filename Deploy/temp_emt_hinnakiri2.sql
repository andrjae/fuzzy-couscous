CREATE OR REPLACE PROCEDURE TBCIS.Temp_EMT_HINNAKIRI2 as
...
and pro_rata='Y' and regular_charge='Y' and once_off='N' and daily_charge='Y'
...
from fixed_charge_item_types f, price_lists p
 where f.pro_rata='Y'and   f.once_off='N' and f.regular_charge='Y' and f.daily_charge='Y'
   and f.package_category is not null
   and p.pro_rata='Y'and   p.once_off='N' and p.regular_charge='Y' and p.daily_charge='Y'
...
select 1 from tbcis.emt_bill_price_list 
...
--DBMS_OUTPUT.Put_Line(' eri pole ' ||r.sept_type_code ||' '||to_char(r.sepv_ref_num)||' '||r.type_code); 
       ...
       INSERT
        INTO tbcis.emt_bill_price_list (fcty_type
                                 ,what
                                 ,list_type
                                 ,fcit_type_code
                                 ,taty_type_code
