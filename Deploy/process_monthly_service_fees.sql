CREATE OR REPLACE PACKAGE PROCESS_MONTHLY_SERVICE_FEES AS
   /********************************************************************
   **
   **  Module      :  BCCU1284
   **  Module Name : PROCESS_MONTHLY_SERVICE_FEES
   **  Date Created:  10.10.2005
   **  Author      :  U.Aarna
   **  Description :  Pakett sisaldab protseduure päevade arvust s?ltumatute
   **                 (prorata = N) teenuse kuumaksude leidmiseks.
   **
   ** -------------------------------------------------------------
   ** Version Date       Modified by Reason
   ** -------------------------------------------------------------
   **   1.45 05.02.2019 A.Jaek       DOBAS-1721: Lisatud process.daily_charges.proc_daily_charges_ma väljakutse
   **   1.44 15.09.2017 Inge Reeder  DOBAS-158 Komplekti kuutasude arveldamise protsessis eemaldatud teenuse miinimumtasu nõude
   **                                           Täiendatud protseduure:
   **                                            --create_nonker_serv_fee_inen,create_nonker_serv_fee_comc
   **   1.43 28.02.2017 Inge Reeder  MOBET-107 Mobet-22 ei läinud Live, s.o. mobet-22 edasiarendus/täiendus
   **                                           Komplekti kuutasu arveldamise protsess peab arvestama teenuse kuutasu soodustusega
   **                                           Täiendatud protseduure:
   **                                            -- create_nonker_serv_fee_comc
   **                                            -- proc_one_maac_nonker_serv_fees
   **   1.42  14.12.2016 A.Soo       MOBET-22 - Komplekti kuutasu arveldamise protsess peab arvestama teenuse kuutasu soodustusega
   **                                          Täiendatud protseduure:
   **                                            -- create_nonker_serv_fee_comc
   **                                            -- proc_one_maac_nonker_serv_fees
   **   1.41  14.10.2015 A.Soo       MOBE-221 - Internetikomplekti juurdehindlus (markup)
   **                                          Täiendatud protseduure:
   **                                            -- create_nonker_serv_fee_comc
   **                                            -- create_nonker_serv_fee_inen
   **   1.40  03.07.2015 A.Soo       ETEENUP-146 - Arvele 0 kuutasuga teenus komplektis ei tule arvele - FIX
   **                                          Täiendatud protseduure:
   **                                            -- calc_mob_nonker_serv_fee
   **   1.39  29.06.2015 A.Soo       ETEENUP-132 - Arvele 0 kuutasuga teenus komplektis ei tule arvele
   **                                          Täiendatud protseduure:
   **                                            -- proc_one_maac_nonker_serv_fees
   **   1.38  08.08.2014 A.Soo       CHG-4482: IS-11413 - NonKer kuutasude optimeerimine
   **                                          Täiendatud protseduure:
   **                                            -- proc_mob_nonker_service_fees
   **                                            -- chk_mobile_nonker_service_fees
   **                                            -- get_period_max_price
   **                                          Uus protseduur:
   **                                            -- Create_Price_Tables
   **   1.37  23.05.2014 A.Soo       CHG-13755: IS-18755 - KTL: parandatud teenuse hinnastamise ülekatet.
   **                                          Täiendatud protseduure:
   **                                            -- Add_Mixed_Packet_Service_Dates
   **   1.36  21.03.2014 A.Soo       CHG-13641: IS-14256 - Saldostopi arvutamine ei arvesta komplektis oleva soodustusega
   **                                          Täiendatud protseduure:
   **                                            -- create_nonker_serv_fee_inen
   **                                            -- proc_one_maac_nonker_serv_fees
   **   1.35  13.03.2014 A.Soo       CHG-13617: IS-17074 - MinuEMT kuutasude seos tabelisse COMMON_MONTHLY_CHARGES
   **                                          Täiendatud protseduure:
   **                                            -- create_nonker_serv_fee_inen
   **                                            -- chk_one_maac_calculated_fees
   **   1.34  13.09.2013 A.Soo       CHG-6386: PAK müük testperioodiga. GPRS maksustamine
   **                                          Uued protseduurid/funktsioonid:
   **                                            -- Get_Test_Period_Data
   **                                            -- get_service_name_from_sety_ref
   **                                          Täiendatud protseduuri:
   **                                            -- create_nonker_serv_fee_comc
   **                                            -- get_period_max_price
   **                                            -- proc_one_maac_nonker_serv_fees
   **                                            -- calc_mob_nonker_serv_fee
   **   1.33  05.08.2013 A.Soo       CHG-6527: Välistada MN3 ja ilma bill_cycle-ta kirjed (kursor c_maac).
   **                                          Täiendatud protseduuri:
   **                                            -- chk_master_service_fees
   **   1.32  03.07.2013 A.Soo       CHG-6518: IS-14355 Välistada MN3 ja ilma bill_cycle-ta kirjed.
   **                                          Täiendatud protseduuri:
   **                                            -- chk_master_service_fees
   **   1.31  11.03.2013 A.Soo       CHG-6381: IS-13386 Parandatud teenus+pakett kursorid, et vältida paketivahetusel suletud teenuse
   **                                          maksustamist järgmises paketis.
   **                                          Täiendatud protseduure:
   **                                            -- chk_mobile_nonker_service_fees
   **                                            -- chk_mob_nonker_serv_fees_by_ma
   **   1.30  12.02.2013 A.Soo       CHG-6319: Paketeeritud müügi teenuste kuutasude parandus seadme garantii korral.
   **                                          Täiendatud protseduuri:
   **                                            -- calc_mob_nonker_serv_fee
   **                                            -- proc_one_maac_nonker_serv_fees
   **   1.29  09.10.2012 A.Soo       CHG-6068: Saldostop peab arvestama PAK puhul teenuste kuutasudega.
   **                                          Täiendatud protseduuri:
   **                                            -- chk_mob_nonker_serv_fees_by_ma
   **   1.28  31.01.2013 A.Soo       CHG-6214: IS-11555 Paketi lõpukuul teenuste tasud päevapõhiselt.
   **                                          Täiendatud protseduuri:
   **                                            -- get_period_max_price
   **                                            -- get_period_ma_serv_price
   **   1.27  16.05.2012 A.Soo       CHG-5826: Paketeeritud müük 2 parandus
   **                                          Täiendatud protseduuri:
   **                                            -- Add_Mixed_Packet_Service_Dates
   **   1.26  30.04.2012 A.Soo       CHG-5762: Paketeeritud müük 2.
   **                                          Täiendatud protseduure
   **                                            -- chk_mob_nonker_serv_fees_by_ma
   **                                            -- chk_mobile_nonker_service_fees
   **                                            -- proc_one_maac_nonker_serv_fees
   ...
   **                                            -- Add_Mixed_Packet_Service_Dates
   **                                            -- create_nonker_serv_fee_comc
   **   1.25  21.01.2011 A.Soo       CHG-4803: IS-7008. Pere250 kuumaks.
   **                                          Vaadeldakse teenuse küljes defineeritud mobiilipakette.
   **                                          Täiendatud protseduuri
   **                                            -- chk_one_maac_ma_calculated_fee
   **   1.24  23.11.2010 H.Luhasalu  CHG4700: Muudetud käivitamise alguse kontrolle
   **   1.23  18.11.2010 K.Peil      CHG4594, IS-5573: INEN.EEK_AMT muutmise asemel INEN.ACC_AMOUNT, 
   **                                                  täpsusega GET_INEN_ACC_PRECISION
   **   1.22  15.11.2010 A.Soo       CHG-4707: MeieEMT koondarveteenuste soodustused.
   **                                          Täiendatud protseduuri
   **                                            -- get_period_ma_serv_price
   **                                            -- chk_one_maac_ma_calculated_fee
   **                                          Uus protseduur:
   **                                            -- chk_one_maac_ma_discounts
   **   1.21  09.09.2010 A.Soo       CHG-4635: Teenuste kuutasude arvele kandmise parandus (kuutasu arvel eksisteerimise kontroll).
   **                                          MA teenuste arveldamine algab alles peale esimese mobiili liitumist MeieEMT paketiga
   **                                          (vastavalt häälestusele esimest kuud ei maksustata).
   **                                          Täiendatud protseduuri
   **                                            -- Create_NonKER_Serv_Fee_INEN
   **                                            -- Chk_One_MAAC_MA_Calculated_Fee
   **   1.20  29.06.2010 A.Soo       CHG-4535: MeieEMT lahendustasu parandus. Arvel oleva lahendustasu summa tuleb leida kogu arveldusperioodi ulatuses.
   **                                          Täiendatud protseduure:
   **                                            -- Chk_One_MAAC_MA_Calculated_Fee
   **                                            -- Proc_One_MAAC_NonKER_Serv_Fees
   **                                            -- Calc_Mob_NonKER_Serv_Fee
   **   1.19  28.06.2010 A.Soo       CHG-4467: Teenuse parameetri järgi õige soodustuse leidmise parandus.
   **                                          Enne otsiti soodustust viimati leitud sepv-i järgi, nüüd koos leitud hinnaga kehtinud sepv-i järgi.
   **                                          Täiendatud protseduure:
   **                                            -- Calc_Mob_NonKER_Serv_Fee
   **   1.18  25.05.2010 A.Soo       CHG-4418: MeieEMT lahendustasud.
   **                                          Täiendatud protseduure:
   **                                            -- Create_NonKER_Serv_Fee_INEN
   **                                          Uued protseduurid:
   **                                            -- Get_Period_MA_Serv_Price
   **                                            -- Chk_One_MAAC_MA_Calculated_Fee
   **   1.17  29.03.2010 A.Soo       CHG-3946: Topelt kuutasu soodustuste välistamine. Soodustuse lisamine lahendustasule.
   **                                          Eemaldatud teenuse mitmekordne hinnastamine perioodis (tunnus Bill_Fcit_Type_Code).
   **                                          Teenuse hinnastamist ei vaadelda enam AC perioodide kaupa, vaid teenus+pakett perioodidega.
   **                                          Lisaks ei hinnastata teenust teenuse/mobiili sulgemisel arveldusperioodi esimesel kuupäeval
   **                                          enne vastavat kella-aega (süsteemne parameeter 624).
   **                                          Täiendatud protseduure:
   **                                            -- Chk_One_MAAC_Calculated_Fees
   **                                            -- Proc_One_MAAC_NonKER_Serv_Fees
   **                                            -- Calc_Mob_NonKER_Serv_Fee
   **                                            -- Chk_Mob_NonKER_Serv_Fees_By_MA
   **   1.16  11.02.2010 A.Soo       CHG-4247: Kuutasu soodustuste parandus. Masteri viimase susg+sety töötlusel
   **                                          ei suudetud leida sootustuse tüüpi.
   **                                          Täiendatud protseduuri:
   **                                            -- Proc_One_MAAC_NonKER_Serv_Fees
   **   1.15  17.11.2009 A.Soo       CHG-3360: Kuutasu soodustustele lisatud interim parameeter.
   **                                          Täiendatud protseduuri:
   **                                            -- Proc_One_MAAC_NonKER_Serv_Fees
   **   1.14  28.10.2009 A.Soo       CHG-4079: NonKER Teenuste kuutasude soodustuste täiendus.
   **                                          Täiendatud protseduuri:
   **                                            -- Proc_One_MAAC_NonKER_Serv_Fees
   **   1.13  08.09.2009 A.Soo       CHG-3984: NonKER Teenuste kuutasude soodustuste parandus.
   **                                          Soodustus leitakse arvele kantava summa pealt (parandus seoses vahearvetega).
   **                                          Soodustuse arvutamise kuupäevaks on perioodi lõpu kuupäev, mitte SYSDATE.
   **                                          Täiendatud protseduure:
   **                                            -- Create_NonKER_Serv_Fee_INEN
   **                                            -- Proc_One_MAAC_NonKER_Serv_Fees
   **                                            -- Chk_One_MAAC_Calculated_Fees
   **   1.12  23.07.2009 A.Soo       CHG-3908: NonKER Teenuste kuutasude soodustused.
   **                                          Lisatud ka testprotseduur ühe MAACi NonKER teenuste arvele kandmiseks.
   **                                          Täiendatud protseduure:
   **                                            -- Get_Period_Max_Price
   **                                            -- Calc_Mob_NonKER_Serv_Fee
   **                                            -- Proc_One_MAAC_NonKER_Serv_Fees
   **                                            -- Run_One_MAAC_NonKER_Serv_Fees
   **   1.11  16.06.2009 A.Soo       CHG-3861: POP - päevapõhise hinnastuse parandus.
   **                                          NonKER teenuste kuutasude kursorist välistatud 'LAMA' domeeni koondarved.
   **                                          Täiendatud protseduure:
   **                                            -- Get_Period_Max_Price
   **                                            -- Chk_Mobile_NonKER_Service_Fees
   **   1.10  26.05.2009 A.Soo       CHG-3832: POP. Lahendustasu teenuste soodustused - Chk_One_MAAC_Calculated_Fees.
   **   1.9   01.05.2009 A.Soo       CHG-3811: POP. Päevapõhise hinna leidmise parandus - get_period_max_price.
   **   1.8   27.04.2009 A.Soo       CHG-3714: POP. Lahendustasu lisamine teenuste pealt.
   **                                          Täiendatud protseduure:
   **                                            -- Proc_One_MAAC_NonKER_Serv_Fees
   **                                            -- Create_NonKER_Serv_Fee_INEN
   **                                            -- Get_Period_Max_Price
   **                                          Uus protseduur:
   **                                            -- Chk_One_MAAC_Solution_Fees
   **   1.7   06.03.2009 A.Soo       CHG-3704: Teenuste FIX tasude täiendus.
   **                                          Täiendatud protseduure:
   **                                            -- Chk_Mobile_NonKER_Service_Fees
   **                                            -- Calc_Mob_NonKER_Serv_Fee
   **                                            -- Get_Period_Max_Price
   **                                            -- Proc_One_MAAC_NonKER_Serv_Fees
   **   1.6   15.12.2008 A.Soo       CHG-2795: Teenuste FIX tasude erinevad häälestused. Muudetud hinna arvutamise loogikat.
   **                                          Täiendatud protseduuri:
   **                                            -- Get_Period_Max_Price
   **   1.5   01.11.2006 U.Aarna     CHG-1379: Parandatud koondarvete PL/SQL tabeli indekseerimine protseduurides Chk_Master_Service_Fees, Invoice_Service_Fees.
   **   1.4   06.10.2006 U.Aarna     CHG-1241: Täiendatud protseduuri Chk_Mobile_NonKER_Service_Fees p?hikursorit.
   **   1.3   04.05.2006 U.Aarna     CHG-873:  Lisatud käivituse kuupäevade määramine arveldustsüklitele, millel pole vastavaid teenuseid.
   **   1.2   15.03.2006 U.Aarna     CHG-741:  Päevade arvust s?ltumatu kuutasu leidmisel arvestatakse ka mobiili taseme erihinnaga.
   **                                          See hind on ühtlasi k?ige prioriteetsem ehk kui see mingis perioodis on olemas, siis
   **                                          v?etakse hind just sealt ja hinnakirja + muid erihindu ei vaadata.
   **                                          Täiendatud lokaalset protseduuri Get_Period_Max_Price.
   **   1.1   08.02.2006 U.Aarna     CHG-662:  Mobiilitaseme teenuste kuutasude arvutamisel välja arvatud ettemaksukaardid.
   **                                          Täiendatud protseduure:
   **                                            -- Chk_Mobile_KER_Service_Fees
   **                                            -- Chk_Mobile_NonKER_Service_Fees
   **   1.0   10.10.2005 U.Aarna     CHG-498:  Initial version
   **
   **********************************************************************/
   ...
   */
   ...
   g_GET_INEN_ACC_PRECISION CONSTANT number := GET_INEN_ACC_PRECISION;
   /*
...
--
END process_monthly_service_fees;
/

CREATE OR REPLACE PACKAGE BODY PROCESS_MONTHLY_SERVICE_FEES AS
   /*
   ...
   BEGIN
      ...
      */
      ...
      IF l_allowed THEN
         ...
         */
         calculate_fixed_charges.get_non_prorata_mob_serv_price
                                                      (p_susg_ref_num   -- IN     subs_serv_groups.ref_num%TYPE
                                                      ,p_sety_ref_num   -- IN     service_types.ref_num%TYPE
   ...
   BEGIN
      ...
      */
      ...
      /*
        ** Leiame hinnakirjajärgse- v?i erihinna.
      */
      calculate_fixed_charges.get_non_prorata_ma_serv_price
                                                (p_maac_ref_num   -- IN     master_accounts_v.ref_num%TYPE
                                                ,p_maas_ref_num   -- IN     master_account_services.ref_num%TYPE
                                                ,p_sety_ref_num   -- IN     service_types.ref_num%TYPE
                                                ,p_end_date   -- IN     DATE
   ...
   ****************************************************************************/
   ...
   BEGIN
      ...
      */
      ...
      --
      IF NVL (l_price, 0) > 0 THEN
         calculate_fixed_charges.create_entries
         ...
         --
         calculate_discounts.find_oo_conn_discounts (p_discount_type   -- VARCHAR2
      ...
      */
      ...
      IF NVL (l_price, 0) > 0 THEN
         IF p_interim_bal THEN
            ...
            END IF;
         ELSE
            calculate_fixed_charges.g_inen_rowid := NULL;
            calculate_fixed_charges.create_entries
                        (p_success   -- IN OUT BOOLEAN
                        ,p_error_text   -- IN OUT varchar2
                        ,p_invo_ref_num   -- IN     invoices.ref_num%TYPE
            ...
            --
            l_inen_rowid := calculate_fixed_charges.g_inen_rowid;
            calculate_fixed_charges.g_inen_rowid := NULL;
            ...
            */
            IF l_masa_rec.cadc_ref_num IS NOT NULL THEN
               ...
               */
               ...
               --
               l_discount_amount :=
                  calculate_discounts.get_ma_serv_discount_amount
               ...
               --
               l_fcit_rec := calculate_fixed_charges.get_fcit_rec (l_fcit_type_code);
               --
   ...
   ****************************************************************************/
   ...
   BEGIN
      ...
      */
      calculate_fixed_charges.write_down_invoice_entries
   ...
   ****************************************************************************/
   PROCEDURE create_nonker_serv_fee_inen (
     ...
     ,p_interim           IN      BOOLEAN DEFAULT FALSE  -- CHG-13641
      ...
      l_inen_sum_tab                calculate_fixed_charges.t_inen_sum;
   ...
   BEGIN
      ...
      */
      ...
      IF l_sum_to_invoice > 0 THEN
         ...
         */
         calculate_fixed_charges.add_invoice_entry
                                 (p_inen_tab           -- IN OUT t_inen
               ...
               */
               IF l_sum_to_invoice > 0 THEN
                  ...
                  */
                  ...
                  --
                  Calculate_Fixed_Charges.ins_common_monthly_charges (l_inen_rec);
                  --
               END IF;
               ...
               IF l_sum_to_invoice > 0  and nvl(l_discount,0) = 0  THEN
                  ...
                  CLOSE c_fcit;
                  -- 
                  l_discount_type := Calculate_Discounts.find_discount_type(l_fcit_rec.pro_rata
                                                                           ,l_fcit_rec.regular_charge                                                                         ,l_fcit_rec.once_off
                                                                           );
                  --
                  Calculate_Discounts.find_oo_conn_discounts(l_discount_type
                                                            ,p_invo_ref_num
                                                            ,p_fcit_type_code
                                                            ,p_billing_selector
                                                            ,p_sepv_ref_num 
   ...
   *****************************************************************************/
   PROCEDURE chk_one_maac_ma_calculated_fee (
     ...
     ,p_interim       IN  BOOLEAN DEFAULT FALSE
      ...
      l_calc_idx                    NUMBER;
      l_inen_tab                    calculate_fixed_charges.t_inen;
      l_calc_tab                    calculate_fixed_charges.t_inen;
      l_taty_type_code              tax_types.tax_type_code%TYPE;
      l_billing_selector            billing_selectors_v.type_code%TYPE;
      l_fcit_type_code              fixed_charge_item_types.type_code%TYPE;
      ...
      WHILE l_idx IS NOT NULL LOOP
         ...
         IF l_fcit_rec.bill_fcit_type_code IS NOT NULL THEN
            ...
            */
            IF NOT p_interim THEN
               --
               calculate_fixed_charges.ins_common_monthly_charges (l_inen_tab (l_idx));
            --
            END IF;
            --
         END IF; -- CHG-4803
            ...
            */
            IF NVL (l_inen_tab (l_idx).eek_amt, 0) > 0 THEN
               --
               process_monthly_service_fees.chk_one_maac_ma_discounts
